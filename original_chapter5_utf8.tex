...
%-----------------------------------
\section{The Intelligent Generator}
\label{sec:generator}
...
Figure~\ref{fig:generator_sequence} illustrates the complete interaction sequence between the administrator, the Intelligent Generator UI, the database, and the solver engine during an automated timetable generation session.
