...
To support automated timetable generation, the schema includes three mapping tables (shown in green in Figure~\ref{fig:er_diagram}). These are used by the Intelligent Generator and the solver engine:
\begin{itemize}
    ...
    \item \textbf{\texttt{professor\_expertise}:} Links professors to the subjects they are qualified to teach, along with a \texttt{preference\_level}. The auto-fill feature in the Intelligent Generator uses this to intelligently suggest professor assignments.
\end{itemize}
