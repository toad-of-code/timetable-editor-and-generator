...
\usepackage{lipsum}
\usepackage{helvet} % Helvetica (metrically identical to Arial)
\renewcommand{\familydefault}{\sfdefault} % Use sans-serif (Helvetica/Arial) as default
\usepackage{tikz} % For drawing diagrams natively
\usetikzlibrary{shapes.geometric, arrows.meta, positioning, fit, calc, shapes.multipart}
...
\usepackage{transparent} % For setting image opacity
\usepackage{float} % Required for the [H] figure positioning specifier
